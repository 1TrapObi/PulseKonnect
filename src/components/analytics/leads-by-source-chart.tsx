...
export type LeadsBySourceDatum = { source: string; total: number };

export function LeadsBySourceChart({ data }: { data: LeadsBySourceDatum[] }) {
  return (
    <Card>
      <CardHeader>
        ...
        {data.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data} layout="vertical" margin={{ left: 24, right: 12 }}>
              ...
              <YAxis type="category" dataKey="source" width={140} />
              <Tooltip />
